...
import move.org.antlr.v4.runtime.tree.ParseTreeVisitor;
...
public interface GLSLParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link GLSLParser#pragmaStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPragmaStatement(GLSLParser.PragmaStatementContext ctx);
	/**
	 * Visit a parse tree produced by {@link GLSLParser#extensionStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExtensionStatement(GLSLParser.ExtensionStatementContext ctx);
	/**
	 * Visit a parse tree produced by {@link GLSLParser#customDirectiveStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCustomDirectiveStatement(GLSLParser.CustomDirectiveStatementContext ctx);
	/**
	 * Visit a parse tree produced by {@link GLSLParser#includeStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIncludeStatement(GLSLParser.IncludeStatementContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitSequenceExpression(GLSLParser.SequenceExpressionContext ctx);
	/**
