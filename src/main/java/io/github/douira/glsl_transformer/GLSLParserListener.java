...
import move.org.antlr.v4.runtime.tree.ParseTreeListener;
...
public interface GLSLParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link GLSLParser#pragmaStatement}.
	 * @param ctx the parse tree
	 */
	void enterPragmaStatement(GLSLParser.PragmaStatementContext ctx);
	/**
	 * Exit a parse tree produced by {@link GLSLParser#pragmaStatement}.
	 * @param ctx the parse tree
	 */
	void exitPragmaStatement(GLSLParser.PragmaStatementContext ctx);
	/**
	 * Enter a parse tree produced by {@link GLSLParser#extensionStatement}.
	 * @param ctx the parse tree
	 */
	void enterExtensionStatement(GLSLParser.ExtensionStatementContext ctx);
	/**
	 * Exit a parse tree produced by {@link GLSLParser#extensionStatement}.
	 * @param ctx the parse tree
	 */
	void exitExtensionStatement(GLSLParser.ExtensionStatementContext ctx);
	/**
	 * Enter a parse tree produced by {@link GLSLParser#customDirectiveStatement}.
	 * @param ctx the parse tree
	 */
	void enterCustomDirectiveStatement(GLSLParser.CustomDirectiveStatementContext ctx);
	/**
	 * Exit a parse tree produced by {@link GLSLParser#customDirectiveStatement}.
	 * @param ctx the parse tree
	 */
	void exitCustomDirectiveStatement(GLSLParser.CustomDirectiveStatementContext ctx);
	/**
	 * Enter a parse tree produced by {@link GLSLParser#includeStatement}.
	 * @param ctx the parse tree
	 */
	void enterIncludeStatement(GLSLParser.IncludeStatementContext ctx);
	/**
	 * Exit a parse tree produced by {@link GLSLParser#includeStatement}.
	 * @param ctx the parse tree
	 */
	void exitIncludeStatement(GLSLParser.IncludeStatementContext ctx);
	/**
	 ...
	 * labeled alternative in {@link GLSLParser#expression}.
	 * @param ctx the parse tree
	 */
	 ...
	 * @param ctx the parse tree
	 */
	void enterSequenceExpression(GLSLParser.SequenceExpressionContext ctx);
	/**
	 * Exit a parse tree produced by the {@code sequenceExpression}
	 * labeled alternative in {@link GLSLParser#expression}.
	 * @param ctx the parse tree
	 */
	void exitSequenceExpression(GLSLParser.SequenceExpressionContext ctx);
	/**
