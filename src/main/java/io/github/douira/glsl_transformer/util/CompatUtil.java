...
public class CompatUtil {
  ...
  /**
   * Creates a {@link HashSet} that contains the given items. The heap
   * pollution warning is suppressed as it is in {@link Arrays}.
   * 
  ...
  /**
   * Creates a {@link HashSet} that contains the given item.
   * 
  ...
  /**
   * Creates a {@link HashSet} that contains the given items.
   * 
   * @param <V>   The type of the items
  ...
  /**
   * Creates an {@link ArrayList} that contains the given items in the
