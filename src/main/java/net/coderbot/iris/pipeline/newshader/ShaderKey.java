...
public enum ShaderKey {
	...
	HAND_TEXT              (ProgramId.Hand,        AlphaTests.NON_ZERO_ALPHA,  IrisVertexFormats.TERRAIN                       , FogMode.PER_VERTEX,   LightingModel.LIGHTMAP  ),
	HAND_TEXT_INTENSITY    (ProgramId.Hand,        AlphaTests.NON_ZERO_ALPHA,  IrisVertexFormats.TERRAIN                       , FogMode.PER_VERTEX,   LightingModel.LIGHTMAP  ),
	...
	TEXT                   (ProgramId.Entities,    AlphaTests.ONE_TENTH_ALPHA,  DefaultVertexFormat.POSITION_COLOR_TEX_LIGHTMAP, FogMode.PER_VERTEX,   LightingModel.LIGHTMAP  ),
	TEXT_INTENSITY         (ProgramId.Entities,    AlphaTests.ONE_TENTH_ALPHA,  DefaultVertexFormat.POSITION_COLOR_TEX_LIGHTMAP, FogMode.PER_VERTEX,   LightingModel.LIGHTMAP  ),
	TEXT_BE                (ProgramId.Block,       AlphaTests.ONE_TENTH_ALPHA,  DefaultVertexFormat.POSITION_COLOR_TEX_LIGHTMAP, FogMode.PER_VERTEX,   LightingModel.LIGHTMAP  ),
	TEXT_INTENSITY_BE      (ProgramId.Block,       AlphaTests.ONE_TENTH_ALPHA,  DefaultVertexFormat.POSITION_COLOR_TEX_LIGHTMAP, FogMode.PER_VERTEX,   LightingModel.LIGHTMAP  ),
